...
static char *fonts[]          = { "monospace:size=18:antialias=true:autohint=true", "JoyPixels:pixelsize=18:antialias=true:autohint=true"  };
/*
static char *fonts[] = {
...
/* tagging */
static const char *tags[] = { "Work", "Moah work", "Ref", "Media", "5", "6", "7", "8", "9", "X" };
...
/* key definitions */
#define MODKEY Mod1Mask /* aka Left Alt */
#define SUPERKEY Mod4Mask /* aka Win key */
...
static Key keys[] = {
	...
	/* Open/close terminal (st or kitty) in scratchpad */
	...
	/* [OTHERS] */
	/* Open file manager */
	{ SUPERKEY,			XK_f,		spawn,		SHCMD("thunar") },
	/* Open Surf */
